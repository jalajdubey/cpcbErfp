  ...
  "node_modules/bootstrap/dist/js/bootstrap.bundle.min.js"(exports, module) {
    !(function(t, e) {
      ...
      function S(t2, e2, i2, n2, s2) {
        ...
        const d2 = O(r2, e2.replace(v, "")), u2 = o2 ? /* @__PURE__ */ (function(t3, e3, i3) {
          return function n3(s3) {
            ...
            for (let { target: r3 } = s3; r3 && r3 !== this; r3 = r3.parentNode) for (const a3 of o3) if (a3 === r3) return M(s3, { delegateTarget: r3 }), n3.oneOff && P.off(t3, s3.type, e3, i3), i3.apply(r3, [s3]);
          };
      ...
      class Ui extends $ {
        ...
        _checkContent(t2) {
          for (const [e2, i2] of Object.entries(t2)) super._typeCheckConfig({ selector: e2, entry: i2 }, Yi);
        }
      ...
      class ln extends W {
        ...
        show() {
          ...
          if (this._element.ownerDocument.documentElement.contains(this.tip) || (n2.append(i2), P.trigger(this._element, this.constructor.eventName("inserted"))), this._popper = this._createPopper(i2), i2.classList.add(Zi), "ontouchstart" in document.documentElement) for (const t3 of [].concat(...document.body.children)) P.on(t3, "mouseover", h);
          this._queueCallback((() => {
        ...
        hide() {
          if (this._isShown() && !P.trigger(this._element, this.constructor.eventName("hide")).defaultPrevented) {
            if (this._getTipElement().classList.remove(Zi), "ontouchstart" in document.documentElement) for (const t2 of [].concat(...document.body.children)) P.off(t2, "mouseover", h);
        ...
        _getConfig(t2) {
          ...
          for (const t3 of Object.keys(e2)) Gi.has(t3) && delete e2[t3];
      ...
      class _n extends W {
        ...
        _activateParents(t2) {
          if (t2.classList.contains("dropdown-item")) z.findOne(".dropdown-toggle", t2.closest(".dropdown")).classList.add(fn);
          else for (const e2 of z.parents(t2, ".nav, .list-group")) for (const t3 of z.prev(e2, ".nav-link, .nav-item > .nav-link, .list-group-item")) t3.classList.add(fn);
        }
        _clearActiveClass(t2) {
          t2.classList.remove(fn);
          const e2 = z.find("[href].active", t2);
          for (const t3 of e2) t3.classList.remove(fn);
        }
        static jQueryInterface(t2) {
          return this.each((function() {
      ...
      P.on(window, "load.bs.scrollspy.data-api", (() => {
        for (const t2 of z.find('[data-bs-spy="scroll"]')) _n.getOrCreateInstance(t2);
      })), m(_n);
      ...
      class xn extends W {
        ...
        _keydown(t2) {
          if (![bn, vn, yn, wn].includes(t2.key)) return;
      ...
      P.on(document, "click.bs.tab", Cn, (function(t2) {
        ...
        for (const t2 of z.find('.active[data-bs-toggle="tab"], .active[data-bs-toggle="pill"], .active[data-bs-toggle="list"]')) xn.getOrCreateInstance(t2);
      })), m(xn);
