  ...
  <div class="row justify-content-center">
    <div class="col-lg-12 col-xl-12 col-xxl-11">
      ...
      <form method="POST" action="{{ route('register.process') }}" id="registrationForm"
       ...
       <!-- 1. company Name Module -->
        <div class="card form-section">
          <div class="card-header">
            <h5 class="mb-0"><span class="form-section-number">Company Details</h5>
          </div>
          <div class="card-body">
            <div class="row g-3">
              <div class="col-md-4">
                <label class="form-label required">Company Name</label>
                <input type="text" name="industry_name" class="form-control underline-only" placeholder="Name of Company" maxlength="400" autocomplete="off" value="{{ old('industry_name') }}">
        ...
        <div class="card form-section">
          <div class="card-header">
            <h5 class="mb-0"><span class="form-section-number">Company Address</h5>
          </div>
          <div class="card-body">
            <div class="row g-3">
              <div class="col-md-4">
          ...
          <div class="card-body">
            <div class="row g-3">
              <div class="col-md-4">
                ...
                <input type="email" name="industry_email" class="form-control underline-only" required value="{{ old('industry_email') }}" placeholder="Enter Company Email" maxlength="100" autocomplete="off">
